...
class BehandlingstatusTest {
    ...
    @Test
    fun `Venter selv på inntektsmelding _ER_ signalet som sier at vi venter på arbeidsgiver`() =
        e2e {
            val søknadId = UUID.randomUUID()
            val vedtaksperiodeId = UUID.randomUUID()
    ...
    private fun E2ETestContext.sendSøknad(
        søknadId: UUID,
        eksternSøknadId: UUID = UUID.randomUUID(),
    ) {
        every {
    ...
    private fun E2ETestContext.sendBehandlingOpprettet(
    ...
    private fun E2ETestContext.sendVedtaksperiodeVenter(
        vedtaksperiodeId: UUID,
        hva: String,
        venterPåVedtaksperiodeId: UUID = vedtaksperiodeId,
        venterPåOrganisasjonsnummer: String = "999999999",
        søknadId: UUID,
    ) {
        @Language("JSON")
        val melding =
    ...
    private fun E2ETestContext.sendVedtaksperiodeVenterPåGodkjenning(
        vedtaksperiodeId: UUID,
        søknadId: UUID,
    ) = sendVedtaksperiodeVenter(vedtaksperiodeId, "GODKJENNING", søknadId = søknadId)

    private fun E2ETestContext.sendVedtaksperiodeVenterPåInntektsmelding(
        vedtaksperiodeId: UUID,
        venterPåVedtaksperiodeId: UUID = vedtaksperiodeId,
        venterPåOrganisasjonsnummer: String = "999999999",
        søknadId: UUID,
    ) = sendVedtaksperiodeVenter(vedtaksperiodeId, "INNTEKTSMELDING", venterPåVedtaksperiodeId, venterPåOrganisasjonsnummer, søknadId)
