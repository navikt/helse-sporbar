...
internal class VedtaksperiodeVenterRiver(
    ...
    private class VedtaksperiodeVenter private constructor(
        ...
        private companion object {
            private fun venterPå(
                venteårsak: Venteårsak,
                venterPåAnnenPeriode: Boolean,
                venterPåAnnenArbeidsgiver: Boolean,
            ): VenterPå {
